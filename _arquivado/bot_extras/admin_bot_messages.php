...
<head>
    ...
    <style>
        :root {
            --primary: #0055FF;
            --primary-dark: #0044CC;
            --primary-gradient: linear-gradient(135deg, #0055FF 0%, #0088FF 100%);
            --accent: #f59e0b;
            --bg-dark: #0F0F0F;
            --bg-card: #1A1A1A;
...
<body class="flex">
    ...
    <aside class="sidebar w-64 min-h-screen flex flex-col fixed left-0 top-0" id="sidebar">
        ...
        <nav class="flex-1 py-4">
            ...
            <a href="admin_bot_licenses.php" class="sidebar-item flex items-center gap-3 px-6 py-3 text-zinc-300" style="background: linear-gradient(135deg, rgba(255,51,51,0.1), rgba(255,102,0,0.1)); border-left: 3px solid #0055FF;">
            ...
            <a href="admin_bot_messages.php" class="sidebar-item active flex items-center gap-3 px-6 py-3 text-zinc-300" >
