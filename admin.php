...
?>
    ...
    `;
        ...
        function refreshCronLogs() {
            ...
            if (!logsEl) return; // Se elemento não existir, abortar
            ...
            fetch('automation_logs.txt', { cache: 'no-store' })
                ...
                .then(t => {
                    ...
                    logsEl.textContent = last || 'Sem logs.';
                })
                .catch(() => {
                    logsEl.textContent = 'Sem logs disponíveis.';
                });
        }
        ...
        function enviarWhatsappManual(codigo) {
            ...
            fetch(url, {
                ...
                .catch(error => {
                    ...
                    notifyError('❌ Erro manipulado: ' + errorMsg);
                ...
                .finally(() => {
                    // Reabilitar botões sempre, independente do resultado
                    buttons.forEach(btn => {
                        btn.disabled = false;
