...
<body class="flex">
    ...
    <aside class="sidebar w-64 min-h-screen flex flex-col fixed left-0 top-0" id="sidebar">
        ...
        <nav class="flex-1 py-4">
            ...
            <a href="admin_bot_automations.php" class="sidebar-item active flex items-center gap-3 px-6 py-3 text-zinc-300" >
    ...
    <main class="flex-1 ml-64 p-8">
        ...
        <!-- Automations Section -->
        <section id="section-automations" class="section">
