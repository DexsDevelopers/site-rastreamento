...
<head>
    ...
    <title>Loggi - Cadastro de Ponto de Coleta</title>
        ...
        <div class="auth-card">
            <div class="auth-header">
                <a href="index.php" style="text-decoration: none; display: inline-block; margin-bottom: 1rem;">
                    <i class="fas fa-store" style="font-size: 2rem; color: #0055FF;"></i>
                </a>
                <h1>Seja um Ponto Loggi</h1>
                <p>Transforme seu comércio em um ponto de coleta</p>
            </div>

            <form action="index.php" method="GET"> <!-- Simulação -->
                <div class="form-group">
                    <label for="nome_empresa">Nome do Estabelecimento</label>
                    <input type="text" id="nome_empresa" name="nome_empresa" class="form-control"
                        placeholder="Ex: Farmácia Central" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contato" name="contato" class="form-control" placeholder="Nome completo"
                        required>
                </div>
                ...
                <div class="form-group">
                    <label style="display: flex; align-items: top; gap: 8px; font-weight: 400; font-size: 0.85rem;">
                        ...
                        Aceito ser contactado pela equipe comercial.
                    </label>
                </div>

                <button type="submit" class="btn-full">Solicitar Parceria</button>
            </form>
