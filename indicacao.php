...
<body>
    ...
    <div class="container" style="padding-top: 8rem; padding-bottom: 4rem;">
        <div class="hero-content" style="text-align: center; margin-bottom: 3rem;">
            <h1><i class="fas fa-users" style="color: var(--primary);"></i> Sistema de Indicação</h1>
            <p style="color: var(--text-muted); font-size: 1.2rem;">Indique amigos e ganhe prioridade na entrega!</p>
        </div>
        ...
        <div class="features" style="margin-bottom: 2rem;">
            <h2 class="section-title"><i class="fas fa-gift"></i> Vantagens do Sistema de Indicação</h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem; margin-bottom: 3rem;">
            ...
            <div class="search-card">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="comprar_com_indicacao" class="btn-primary" style="background: linear-gradient(135deg, #16a34a, #059669);">
