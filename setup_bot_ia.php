...
try {
    ...
    $knowledge = [
        // Saudações básicas
        ['Olá', 'Olá! 👋 Sou o assistente da Loggi. Como posso ajudar com seu rastreamento?', 'saudacao', 'oi,olá,ola,hey,eae,e aí', 100],
